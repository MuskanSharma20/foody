    ...
    <div class="flex flex-col md:flex-row min-h-screen">
       ...
       <div class="w-full max-w-md  rounded-lg shadow-2xl border-2 p-6 m-4 " >
                ...
                <form action="#" method="POST" >
                    ...
                    <div class="py-4">
                        <button type="submit" class="w-full py-2 font-bold text-white bg-indigo-600 border border-transparent rounded-md shadow-sm hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Sign In</button>
                    </div>
                    <p class="text-sm text-center text-gray-600"> Dont have an account? <a href="signup.php" class="font-medium text-indigo-600 hover:text-indigo-500">Sign up</a></p>
                </form>
            </div>
        </div>
    </div>
