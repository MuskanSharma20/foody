  ...
  <header class="px-4">
   ...
   <section class="w-full px-4">
    <div class="relative mx-auto lg:max-w-7xl">
      <!-- Carousel Wrapper -->
      <div id="carousel" class="overflow-hidden relative lg:h-[91vh]"> <!-- Adjust the height here -->
        <!-- Carousel Items -->
        <div class="carousel-item flex justify-center items-center">
          <img src="https://images.unsplash.com/photo-1576521529275-f0f0d02a93b6?q=80&w=2071&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Slide 1" class="w-full h-full object-cover"> <!-- Adjust the height here -->
        </div>
        <div class="carousel-item hidden">
          <img src="https://images.unsplash.com/photo-1668236534990-73c4ed23043c?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Slide 2" class="w-full h-full object-cover"> <!-- Adjust the height here -->
        </div>
        <div class="carousel-item hidden">
          <img src="https://plus.unsplash.com/premium_photo-1695035006524-ed99577324aa?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D" alt="Slide 3" class="w-full h-full object-cover"> <!-- Adjust the height here -->
        </div>
      </div>
